...
<input type='hidden' name='bno' value='${classroom.bno}'>
<table border='1'>
<tr>
    <th>강의명</th>
...
<tr>
    <th>시작일</th>
    <td><input type='date' name='startTime' value='${classroom.startTime}'></td>
</tr>
<tr>
    <th>종료일</th>
    <td><input type='date' name='endTime' value='${classroom.endTime}'></td>
</tr>
<tr>
    <th>강의실</th>
